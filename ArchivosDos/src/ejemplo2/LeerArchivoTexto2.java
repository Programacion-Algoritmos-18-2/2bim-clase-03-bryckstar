...
public class LeerArchivoTexto2 {
    ...
    public void abrirArchivo() {
        try {
            entrada = new Scanner(new File("estadios2.txt"));
        } // fin de try
    ...
    public ArrayList<Estadio> leerRegistros() {
        ...
        try // lee registros del archivo, usando el objeto Scanner
        {
            ...
            while (entrada.hasNext()) {
                ...
                e.set_nombre(linea_partes.get(0));
                e.set_tipo(linea_partes.get(1));
                e.set_capacidad(Integer.parseInt(linea_partes.get(2)));
                lista.add(e);
